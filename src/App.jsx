...
export default function App() {
  ...
  const [theme, setTheme] = useState(() => localStorage.getItem('vine-theme') || 'dark')

  useEffect(() => {
    document.documentElement.setAttribute('data-theme', theme)
    localStorage.setItem('vine-theme', theme)
  }, [theme])
    ...
    <div className="app">
      ...
      <header className="header">
        ...
        <div className="header-right">
          ...
          <button className="header-btn" onClick={()=>setTheme(t=>t==='dark'?'light':'dark')} aria-label="Theme wechseln">
            {theme==='dark' ? (
